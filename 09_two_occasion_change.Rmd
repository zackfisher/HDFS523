...
- *Individual 1*: Weight at time 1 was $240lbs$ and weight at time 2 is $240lbs$.
  - Relative standing has gone down so there is *negative residualized change*.
...
- When choosing one model it is worth considering what change means in each context (e.g. in a weight loss study is $10$lbs of weight loss the same for people with different weights?)
