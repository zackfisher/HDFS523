...
In Chapter 8 we will round out our discussion of the GLM with **Poisson regression**. 
...
Therefore, we expect a $-0.03$ difference in the log-count of health problems for a 1-level difference in income brackets. Or, all else being equal, we might expect to see a $3\%$ percent decrease in the number of health problems with each additional unit-change in income level.
